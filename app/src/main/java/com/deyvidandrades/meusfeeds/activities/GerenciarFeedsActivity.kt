...
class GerenciarFeedsActivity : AppCompatActivity(), OnItemClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_gerenciar_feeds)
        ...
        carregarFeedGroups(Persistencia.getFeedGroups())
    }
